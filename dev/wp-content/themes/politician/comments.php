...
<?php if ( have_comments() ) : ?>
				<!-- Start Commentlist -->
				<h5><?php _e('Discussion', TEMPLATENAME); ?>&nbsp;-&nbsp;<?php printf( _n( 'One Comment', '%s Comments', get_comments_number(), TEMPLATENAME ), number_format_i18n( get_comments_number() ) );
				?></h5>
...
<?php comment_form(array(
	...
	'comment_field'        => '<fieldset class="textarea-block"><label for="your_message"><strong>' . __('Message', TEMPLATENAME) . '</strong></label><textarea id="your_message" cols="50" rows="4" name="comment" required></textarea></fieldset>',
)); ?>
